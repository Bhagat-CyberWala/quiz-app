    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        startQuizBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                com.web2hack.quizapp.views.DetailFragmentDirections.ActionDetailFragmentToQuizFragment action =
                        (com.web2hack.quizapp.views.DetailFragmentDirections.ActionDetailFragmentToQuizFragment) DetailFragmentDirections.actionDetailFragmentToQuizFragment();
