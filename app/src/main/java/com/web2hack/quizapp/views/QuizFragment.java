...
import com.web2hack.quizapp.Model.QuestionModel;
import com.web2hack.quizapp.R;
import com.web2hack.quizapp.viewModel.QuestionViewModel;
import com.web2hack.quizapp.views.QuizFragmentDirections;
...
public class QuizFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable  Bundle savedInstanceState) {
        ...
        wrongansFeedbackTv=view.findViewById(R.id.wrongansFeedbackTv);
    ...
    private void submitResults() {
        ...
        com.web2hack.quizapp.views.QuizFragmentDirections.ActionQuizFragmentToResultFragment action =
    ...
    private void verifyAnswer(Button button){
        if (canAnswer){
            if (answer.equals(button.getText())){
                ...
                button.setBackground(ContextCompat.getDrawable(getContext() , R.drawable.red_btn_bg));
                wrongAnswer++;
                ansFeedBackTv.setVisibility(View.VISIBLE);
                wrongansFeedbackTv.setVisibility(View.VISIBLE);
                wrongansFeedbackTv.setText("Wrong Answer");
                ansFeedBackTv.setText("Correct Answer :" + answer);
            }
        }
        canAnswer=false;
